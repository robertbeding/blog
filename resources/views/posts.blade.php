    ...
    <div class="row">
      ...
      <div class="col-md-4 mb-3">
        <div class="card">
         ...
         <a href="/post/{{ $post->slug }}" class="text-white text-decoration-none">{{ $post->category->name }}</a></div>
          <img src="https://via.placeholder.com/500x400?{{ $post->category->name }}" class="card-img-top" alt="{{ $post->category->name }}">
          <div class="card-body">
